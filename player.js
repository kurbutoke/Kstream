...
async function load(MediaType, itemId) {
    try {
        ...
        reader.src = MediaType === "movie" ? `https://vidsrc2.to/embed/movie/${data.id}` : `https://vidsrc2.to/embed/tv/${data.id}/1/1`;
...
function servers(serv) {
    ...
    if (media === "movie") {
        switch(serv) {
            case "S1":
                streamingURL = `https://vidsrc2.to/embed/movie/${mid.innerText}`;
                break;
            case "S2":
        ...
        switch(serv) {
            case "S1":
                streamingURL = `https://vidsrc2.to/embed/tv/${mid.innerText}/${s}/${e}`;
                break;
            case "S2":
