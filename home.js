    ...
    if (searchTerm.length > 0) {
        try {
            ...
            data.results.slice(0, 5).forEach((item) => {
                ...
                poster.src = item.poster_path === null ? `${domain}/img/empty.png` : `https://image.tmdb.org/t/p/w200${item.poster_path}`;
...
async function fetchTrendingTV() {
    try {
        ...
        results.forEach((tv, index) => {
            ...
            const posterImg = document.createElement("img");
            posterImg.draggable = false;
            posterImg.src = `https://image.tmdb.org/t/p/w200${tv.poster_path}`;
    ...
    if (!favorites || favorites.length === 0 || favorites === "[]") {
        ...
        for (const favorite of favorites) {
            ...
            try {
                ...
                const posterImg = document.createElement("img");
                posterImg.draggable = false;
                posterImg.src = `https://image.tmdb.org/t/p/w200${data.poster_path}`; 
